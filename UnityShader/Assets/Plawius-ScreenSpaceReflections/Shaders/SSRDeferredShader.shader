...
Shader "Hidden/PlawiusDeferredSSR"
{
    Properties
    {
    	_MainTex ("", any) = "" {} 
...
//	}
	...
	//generates reflection in frag_lerp
	half4 frag_only_SSR (v2f i) : COLOR
    {
    	float4 normal_spec = tex2D( _CameraGBufferTexture2, i.uv);
		normal_spec.a = tex2D( _CameraGBufferTexture1, i.uv).a;
